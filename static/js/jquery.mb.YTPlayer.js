		...
		if (onMobile == false) {
			...
			$('#bg-video-volume').click(function(e){
				...
				if( bgVideoVol.hasClass('fa-volume-off') ) {
					bgVideoVol.removeClass('fa-volume-off').addClass('fa-volume-down').attr('title', 'Mute');
					bgVideo.unmuteYTPVolume();
					bgVideo.setYTPVolume(6);
				} else {
					bgVideoVol.removeClass('fa-volume-down').addClass('fa-volume-off').attr('title', 'Unmute');
